...
func (b *Ball) PlayerCollision(xColl bool, p *Player) {
...
func (g *Game) StateUpdate(screen *ebiten.Image) {
	...
	if g.isGoal {
    	...
    	text.Draw(screen, msg, basicfont.Face7x13, g.GameScreen.Size.X/4, g.GameScreen.Size.Y/4, color.RGBA{R: 255, G: 0, B: 0, A: 255})
	}
}
