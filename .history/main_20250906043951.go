...
func (b *Ball) Move(g *Game) {
	...
	b.PlayerCollision(g.Player1.Pos.X + g.Player1.Size.X, g.Player1.Pos.Y, b.Pos.X)
	b.PlayerCollision(g.Player2.Pos.X, b.Pos.X + b.Size.X)
	
	b.Pos.X += b.Velocity.X
	b.Pos.Y += b.Velocity.Y
}

func (b *Ball) PlayerCollision(xBoundPlayer float32, xBoundBall float32) {
