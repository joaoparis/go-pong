...
func (b *Ball) Move(g *Game) {
	...
	b.PlayerCollision(g.Player1.Pos.X + g.Player1.Size.X, b.Pos.X + b.Size.X)
	b.PlayerCollision(g.Player2, b.Pos.X)
...
func (g *Game) StateUpdate(screen *ebiten.Image) {
	...
	if g.isGoal {
		...
		msg := "Click Me!"
    	text.Draw(screen, msg, basicfont.Face7x13, 60, 90, color.White)
	}
}
